...
class HolidayCalculator {
  ...
  static easterMonday(year: number): Date {
    const easter = HolidayCalculator.easterDay(year)
  ...
  static getHolidaysForYear(year: number): Holiday[] {
    const holidays: Holiday[] = [
      {
        date: HolidayCalculator.formatDate(HolidayCalculator.newYearsDay(year)),
        localName: "Nouvel An",
      },
      {
        date: HolidayCalculator.formatDate(
          HolidayCalculator.easterMonday(year)
        ),
        localName: "Lundi de Pâques",
      },
      {
        date: HolidayCalculator.formatDate(HolidayCalculator.mayDay(year)),
        localName: "Fête du Travail",
      },
      {
        date: HolidayCalculator.formatDate(
          HolidayCalculator.armisticeDe1945(year)
        ),
        localName: "Fête de la Victoire",
      },
      {
        date: HolidayCalculator.formatDate(HolidayCalculator.ascension(year)),
        localName: "Ascension",
      },
      {
        date: HolidayCalculator.formatDate(
          HolidayCalculator.lundiDePentecote(year)
        ),
        localName: "Lundi de Pentecôte",
      },
      {
        date: HolidayCalculator.formatDate(HolidayCalculator.bastilleDay(year)),
        localName: "Fête Nationale",
      },
      {
        date: HolidayCalculator.formatDate(HolidayCalculator.assomption(year)),
        localName: "Assomption",
      },
      {
        date: HolidayCalculator.formatDate(HolidayCalculator.tousSaint(year)),
        localName: "Toussaint",
      },
      {
        date: HolidayCalculator.formatDate(
          HolidayCalculator.armisticeDe1918(year)
        ),
        localName: "Armistice",
      },
      {
        date: HolidayCalculator.formatDate(
          HolidayCalculator.christmasDay(year)
        ),
        localName: "Noël",
      },
    ]
